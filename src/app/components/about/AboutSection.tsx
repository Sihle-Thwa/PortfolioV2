				...
				<div className="c-about-inner">
					<div className="c-about-textblock">
						...
						<p className="c-about-text">
							...
							scalable, and user-centric applications. My journey began with
							Java, SQL, HTML, and CSS, and has since expanded to mastering
							JavaScript, Python, and C, along with frameworks and technologies
							like Next.js, React.js, Node.js, Express.js, TailwindCSS, and
							MaterialUI.
						</p>
						<p className="c-about-muted">
							...
							applications or refining user experiences, I thrive on
							transforming complex challenges into elegant, practical solutions.
						</p>
						<br />
						<p className="c-about-muted">
							I enjoy mentoring the next generation of developers, bridging
							theory with industry practice, and fostering curiosity and
							problem-solving skills in IT and Computer Science. Beyond the
							classroom and code editor, I’m dedicated to continuous learning,
							innovation, and contributing to impactful projects that make
